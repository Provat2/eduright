...
var background2;
var sound_start, sound_end, sound_joy;
var g;
//loading Images...
function preload(){
    sound_start = loadSound("1.mp3");
    sound_end = loadSound("2.mp3");
    sound_joy = loadSound("3.mp3");
...
function draw(){
    ...
    ///gameState - 3 starts
        ...
        if (playerBus2Group.isTouching(obstacle3Group)){gameState = 4;sound_end.play();}
    ...
    //gameState - 4 starts
        ...
        noStroke();
        fill("black");
        text("1> You did a great job of helping the students of this country.",50, 110);
        ...
        text("4> Education is the top right of every child.",50, 200);
        text("5> We should take proper care of the children's rights.",50, 230);
        text("6> Every child should have the right to go to school. School is a part of heaven.",50, 260);
        text("7> Every people should understand the importance of school. More schools should have to be established.",50, 290);
        text("8> We should have proper maintenance of every child\ reaching school. Transportation should be increased.",50, 320);
        text("9> When students will be educated then the whole country will become enriched.",50, 350);
        fill("green");
        ...
        g = createSprite(random(100, displayWidth-100), -10, 10, 10);
        g.shapeColor = rgb(random(255),random(255),random(255));
        g.velocityY = 4;
        g.lifetime = 500;
    }
